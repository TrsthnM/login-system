<x-layout>
    <div class="flex justify-center mt-2 md:mt-10 xl:mt-10 2xl:mt-35">
        <div class="backdrop-blur-xs bg-white/20 border border-gray-300 rounded-2xl p-8 w-107 mb-10">
            <h1 class="text-gray-800 font-bold text-4xl text-center mb-10">Reset Password</h1>
            <form action="{{ route('forgotPassword.reset') }}" method="post">
                ...
                <div class="mt-10">
                    <button type="submit" class="bg-gray-800 font-bold text-white w-full py-3 rounded-2xl cursor-pointer">Reset</button>
                </div>
            </form>
        </div>
    </div>
