<x-layout>
    @auth
        <div class="mt-60 lg:mt-90">
            <h1 class="font-bold text-xl text-center lg:text-4xl text-gray-800 mb-10">Welcome to the Dashboard</h1>
        </div>
    @else
        <div class="mt-30 lg:mt-65">
            ...
            <div class="mt-15">
                <a href="/" class="bg-gray-800 text-white font-bold py-3 px-10 rounded-2xl">Register</a>
            </div>
        </div>
    @endauth
</x-layout>
